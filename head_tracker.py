...
FRAME_RATE = 30  # Process more frames per second for smoother detection
PROCESS_EVERY_N_FRAMES = 2  # Only process every Nth frame to reduce CPU usage
...
CAMERA_INDICES = [0, 1, 2]  # Try built-in (0) first, then USB cameras
